...
void main() {
  ...
  test(
    ...
    () async {
      ...
      final expectedCoordinateSystem = Matrix3.identity();
      ...
      for (final orientationEvent in orientationEvents) {
        expect(
          orientationEvent.coordinateSystem,
          equals(expectedCoordinateSystem),
        );
        expectedCoordinateSystem.multiply(
  ...
  test(
    ...
    () async {
      platform.coordinateSystem = CoordinateSystem.transformed(
        Axis3D.X,
        -Axis3D.Z,
        CoordinateSystem.transformed(Axis3D.X, Axis3D.Y),
      );
      oeStreamController.sink.add(null);
      final orientationEvent = await platform.orientationStream.first;
      expect(
